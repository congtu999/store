...
Route::middleware(['auth', 'role:admin'])->group(function () {
    Route::prefix('/admin')->group(function () {
        Route::post('/upload/service', [UploadController::class, 'cUpload'])->name('upload');
        ...
        Route::prefix('/slide')->group(function () {
            ...
            Route::get('/search-slide', [SlideController::class, 'getSearchSlide'])->name('searchslide');
        });
        ...
        Route::prefix('/banner')->group(function () {
            ...
            Route::get('/search-banner', [BannerController::class, 'getSearchBanner'])->name('searchbanner');
        });
        //admin/menu
        ...
        Route::prefix('/about')->group(function () {
            ...
            Route::post('/update', [AboutController::class, 'update'])->name('about.post-edit');
