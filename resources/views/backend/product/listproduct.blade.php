                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description right">
                                        <a href="{{ route('addproduct') }}"><button class="btn btn-primary"
                                                style="color: aliceblue">Add new product</button></a>
                                    </p>
                                                ...
                                                @if (!empty($product))
                                                    @foreach ($product as $item)
                                                        <tr>
                                                            ...
                                                            <td class="py-1">
                                                                <img src="{{ $item->image_detail_1 }}"
                                                                    style="width: 80px; height: 100px; border-radius: 0%;">
                                                            </td>
                                                            <td class="py-1">
                                                                <img src="{{ $item->image_detail_2 }}"
                                                                    style="width: 80px; height: 100px; border-radius: 0%;">
                                                            </td>
                                                            <td class="py-1">
                                                                <img src="{{ $item->image_detail_3 }}"
                                                                    style="width: 80px; height: 100px; border-radius: 0%;">
                                                            </td>
                                                            <td style="width: 5%">
                                                                {{ $item->description }}
