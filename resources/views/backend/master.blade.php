...
<head>
  ...
  <link rel="stylesheet" href="/backend/dist/css/adminlte.min.css"> --}}
    <!-- endinject -->
    <!-- Plugin css for this page/backend/ -->
    ...
    <!-- End plugin css for this /backend/page -->
    <!-- inject:css -->
...
<body>
    ...
    <!-- endinjec/backend/t -->
    <!-- Plugin j/backend/s for this page -->
    ...
    <!-- End plug/backend/in js for this page -->
    <!-- inject:j/backend/s -->
