                ...
                <div class="col-sm-12">
                    <div class="home-tab">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h2 style="text-align: center">List Slide </h2>
                                    <p class="card-description right">
                                        <a href="{{ route('addslide') }}"><button class="btn btn-primary"
                                                style="color: aliceblue">Add new slide</button></a>
                                                ...
                                                @if (!empty($slide))
                                                    @foreach ($slide as $key => $item)
                                                        <tr>
                                                            ...
                                                            <td> <a href="{{ route('slide.edit', ['id' => $item->id]) }}"
                                                                    class="btn btn-success btn-sm"><i
                                                                        class="fas fa-edit"></i>Sửa</a>
                                                                <a onclick="return confirm('Bạn có chắc chắn muốn xóa ?')"
                                                                    href="{{ route('slide.delete', ['id' => $item->id]) }}"
